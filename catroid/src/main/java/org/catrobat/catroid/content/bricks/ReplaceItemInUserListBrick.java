...
public class ReplaceItemInUserListBrick extends UserListBrick {
	...
	@Override
	public Brick clone() {
		return new ReplaceItemInUserListBrick(getFormulaWithBrickField(BrickField.REPLACE_ITEM_IN_USERLIST_VALUE)
				.clone(), getFormulaWithBrickField(BrickField.REPLACE_ITEM_IN_USERLIST_INDEX).clone(), userList);
	}
